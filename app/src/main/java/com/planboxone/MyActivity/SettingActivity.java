...
public class SettingActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((LinearLayout) findViewById(R.id.lv_aboutus)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                startActivity(Intent.createChooser(localIntent1, "你好"));
            }
        });
        ((LinearLayout) findViewById(R.id.lv_help)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                startActivity(Intent.createChooser(localIntent2, "你好"));
            }
        });
    }
